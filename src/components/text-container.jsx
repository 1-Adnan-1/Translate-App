    ...
    <div className="flex gap-3 mt-5 md:gap-[105px] max-md:flex-col">
      <div className="flex-1">
        <textarea
          ...
          className="w-full min-h-[250px] max-h-[500px] text-black text-[20px] rounded p-[10px] bg-white"
        ></textarea>
      </div>
      <div className="flex-1 relative">
        <textarea
          ...
          className="w-full min-h-[250px] max-h-[500px] text-[20px] rounded p-[10px] bg-zinc-600 text-gray-300"
        ></textarea>
        {isLoading && <Loader />}
      </div>
    </div>
